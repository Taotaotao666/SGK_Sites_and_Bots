...
**但考虑到一些完全不懂这些的小伙伴的查询需求，如果你网页/链接打不开，分享的库用不了，主要是VPN、Telegram的问题，需要帮助、代查的，请联系获取帮助：[点击跳转帮助详情](#label2)**
...
1. **使用方法：** 本文分享的Telegram社工库机器人，需要VPN和Telegram配合使用，才能访问以下社工库链接。否则是打不开链接的，就只能用第一个社工网站 LosePrivacy 进行查询<br>
    ...
    需要vpn推荐或者过程中遇到问题需要帮助的，请联系获取帮助：[点击跳转帮助详情](#label2)
...
**虽然是收费库，但是不付费也能查询，只是结果是打码了的，可以先看看有没有你想要的数据，如果有，再考虑充值解锁或者联系代查**
...
帮助和代查都是收费的，愿意付费寻求帮助的联系。有Tg账号的请尽量通过Tg联系，没有的请用邮箱联系

## 通过Telegram联系: <a href="https://t.me/+rOY6r7F8D-ViZDQ1" target="_blank">点击跳转TG</a><br>
## 通过邮箱联系：nqfdsrsmp@exelica.com

帮查，付费库打码内容解锁，推荐适应所有系统的免费VPN，解决注册Telegram验证码问题，以及其他各种问题，解答疑惑均可。<br>
一次性说清你的需求，高效沟通，废话不回
